...
public class MainBar extends JToolBar implements sun.awt.DisplayChangedListener {
    ...
    private JToggleButton _buttonShape;
    ...
    public MainBar(JFrame frame, State state) {
        ...
        icon = ViewUtilities.createIcon("/arrow.png", buttonLength);
        _buttonShape = new JToggleButton(icon);
        _buttonShape.setToolTipText(PdfPresenter.getLocalizedString("arrow"));
        _buttonShape.addActionListener(new ButtonShapeActionListener());
        _buttonShape.setBorderPainted(PdfPresenter.isOnMac());
        _buttonShape.setOpaque(false);
        _buttonShape.setFocusable(false);
    ...
    private class ButtonShapeActionListener implements ActionListener {
        public void actionPerformed(ActionEvent event) {
            _state.setActiveTool(_state.getShape());
        }
    }
    ...
    private void toolChanged(Tool tool) {
        ...
        _buttonShape.setSelected(tool == _state.getShape());
